...
dnf install -y kubelet-1.23.17 kubectl-1.23.17 kubeadm-1.23.17
...
# kubeadm init --kubernetes-version=v1.23.17 --service-cidr=10.97.0.0/16 --apiserver-advertise-address=192.110.0.11 --ignore-preflight-errors=Swap --image-repository registry.aliyuncs.com/google_containers
